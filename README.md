...
- **ハーネス**: AIエージェントがタスクを処理するのに必要な固有知識と、自己改善可能な運用知識の総体
- **メタハーネス** (`harness/meta/`): ハーネス自体をどう設計・更新・配置するかを定める知識
- **ドメインハーネス** (`harness/domains/`): 特定タスク群を速く正確に進めるための知識

詳細は `harness/meta/definition.md` を参照。
